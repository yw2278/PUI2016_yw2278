...
for it in data['Siri']['ServiceDelivery']['VehicleMonitoringDelivery'][0]['VehicleActivity']:
	fout.writerow([it['MonitoredVehicleJourney']['VehicleLocation']['Latitude'],
	it['MonitoredVehicleJourney']['VehicleLocation']['Longitude'],
	it['MonitoredVehicleJourney']['OnwardCalls']['OnwardCall'][0]['StopPointName'],
	it['MonitoredVehicleJourney']['OnwardCalls']['OnwardCall'][0]['Extensions']['Distances']['PresentableDistance']])
